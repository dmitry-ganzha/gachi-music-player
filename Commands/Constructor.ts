...
export class Command {
    ...
    public type: string;
    // @ts-ignore
    public run (message: wMessage, args?: string[]): Promise<void | unknown>;
    ...
    protected static DeleteMessage = (message: wMessage, time: number = 2e3) => setTimeout(() => message.delete().catch((): null => null), time);
}
